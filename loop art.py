print("===== Star pyrimad pattern =====")
 
rows = int(input("please input a  number of rows for star pattern: "))
...
rows = int(input("please input a number of rows for Floyd's Triangle: "))
number = 1
